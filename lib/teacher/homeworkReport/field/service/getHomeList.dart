...
Future<List<Hw>> FetchTHw(http.Client client) async {
  final SharedPreferences prefs = await SharedPreferences.getInstance();
  var schoolId = prefs.getInt('schoolId');
  var studentId = prefs.getInt('studentId');
  String hwDate = prefs.getString('hwDate');
  try {
    var url = "http://192.168.1.89:88/Api/Login/GetAssignedHomework?schoolId=1&educationYearId=30&gradeId=3&streamId=3&classId=4&nepaliDate=2077-01-16&subjectId=null";
//    print('${Urls.BASE_API_URL}/Login/GetAssignment?schoolId=$schoolId&studentId=$studentId&date=$hwDate');
