...
class _GetYearState extends State<GetYear> {
  ...
  Future getCurrentYear() async {
    ...
    currentYear = prefs.getString('educationalYearNameHwR');
    indexYear = prefs.getInt('indexYearHwR');
    setState(() {
                                ...
                                index == indexYear ? Container(
                                  ...
                                  child: InkWell(
                                    onTap: ()async {
                                      ...
                                      prefs.setInt('indexYearHwR',index);
                                      prefs.setString('educationalYearNameHwR',snapshot.data[index].sYearName);
                                      prefs.setInt('educationalYearIdHwR',snapshot.data[index].educationalYearID);
