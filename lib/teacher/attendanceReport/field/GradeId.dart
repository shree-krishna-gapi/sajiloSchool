...
class GradeId extends StatefulWidget {
  @override
  _GradeIdState createState() => _GradeIdState();
}
class _GradeIdState extends State<GradeId> {
//  Event event;
  int changedNowId;
            ...
            return AlertDialog(
                            ...
                            return snapshot.data.length > 0 ? CupertinoPicker(
                              ...
                              children: new List<Widget>.generate(
                                ...
                                return Align(
                                  ...
                                  child: Text(snapshot.data[index].gradeNameEng,
                                    style: TextStyle(
                                        fontSize: 17,
              ...
              actions: <Widget>[
                FlatButton(
                  ...
                  onPressed: ()async {
                    SharedPreferences prefs = await SharedPreferences.getInstance();
                    prefs.setInt('hwGradeId',changedNowId);
                    setState(() {
