...
Future<List<Grade>> Fetch(http.Client client) async {
  ...
  try {
    ...
    print('${Urls.BASE_API_URL}/login/getgrades?schoolid=$schoolId');
    print('hello');
...
//  final String updatedBy;
 ...
 Grade({this.gradeId,this.gradeNameEng,this.gradeNameNep,
//   this.startingMonth,this.endingMonth,
   this.remarks,this.status,
//   this.createdDate,this.createdBy,
//  this.updatedDate,this.updatedBy,
   this.gradeLevel,this.organizationId,
  });
