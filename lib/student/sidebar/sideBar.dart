...
class _SideBarBodyState extends State<SideBarBody> {
  ...
  getUser() async {
    ...
    String imageLink = pref.getString('studentImageLocation');
    String email = pref.getString('studentEmail');
    print('this is image url $imageLink');
    imageUrl = '${Urls.BASE_API_URL}/$imageLink';
    print('$imageUrl');
    setState(() {
      studentName = names;
      studentEmail = email;
        ...
        children: <Widget>[
          Container(
            child: new UserAccountsDrawerHeader(
              ...
              accountEmail: studentEmail == '' || studentEmail == null ? Text(''):Text('$studentEmail') ,
...
//                          });
                ...
                //   child: ListTile(leading: Container(width: 65,child:
                //   SvgPicture.asset('assets/logo/drawerlogo.svg',
