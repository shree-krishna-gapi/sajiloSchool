...
class _EducationalYearState extends State<EducationalYear> {
  ...
  getCurrentYear() async {
    ...
    String currentYear = prefs.getString('educationalYearNameCalender');
    indexYearCalender = prefs.getInt('indexYearCalender');
    setState(() {
                                ...
                                index == indexYearCalender ? Container(
                                  ...
                                  child: InkWell(
                                    onTap: ()async {
                                      ...
                                      prefs.setInt('indexYearCalender',index);
                                      prefs.setString('educationalYearNameCalender',snapshot.data[index].sYearName);
                                      prefs.setInt('educationalYearIdCalender',snapshot.data[index].educationalYearID);
